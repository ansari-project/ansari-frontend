...
const Footer: React.FC = () => {
  ...
  const containerClass = 'w-full flex-row justify-start items-center pt-1 px-2'
  ...
  return (
    <Pressable onPress={Keyboard.dismiss} className='w-full flex-row justify-start items-center pt-1 px-2'>
