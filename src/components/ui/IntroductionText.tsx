  ...
  return (
    <div className='flex flex-col p-4 gap-4 font-roboto text-sm md:bg-white'>
      ...
      <div className='flex flex-row gap-4'>
        <img src='/icons/flag.svg' alt='Flag Icon' className='h-fit w-[14px]' />
        <div className='hidden md:block font-normal'>
          <Trans i18nKey='flaggingInstructions.desktop'>
            If I say anything wrong, confusing, great, funny or interesting, please let my authors know by sending
            e-mail to
            <a
      ...
      <div className='flex flex-row gap-4'>
        <img src='/icons/languageGreen.svg' alt='Language Icon' className='h-fit w-[14px]' />
